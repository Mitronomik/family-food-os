...
weights and existing atomic paths, but partial evidence does not publish a
family. Published alternatives do not automatically inherit kitchen verification.
